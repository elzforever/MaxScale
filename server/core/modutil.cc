...
// Helper for generating character ranges
...
static const LUT spaces(" \n\t\r");
static const LUT digits(range('0', '9'));
static const LUT alphas(range('A', 'Z') + range('a', 'z'));
static const LUT xdigits("0123456789abcdefABCDEF");
static const LUT specials("\"'`#-/0123456789\\ \n\t\r");
...
static inline bool is_negation(const std::string& str)
{
    bool rval = false;
